...
All required data has been generated by SIG, and is available in [this GitHub repository](https://github.com/oniewankenobi/algothon21). 
...
The program we used to evaluate the algorithm is provided in *eval.py.* Ensure your code runs against this file. 
...
The algorithms where assessed against *unseen, future* price data of the same 100 instruments within the provided simulated trading universe.
